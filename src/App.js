...
function App() {
  return (
    <div className="w-screen min-h-screen py-48 text-center bg-stone-100 text-stone-800 font-sans space-y-48 flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col text-3xl md:text-5xl items-center">
        <div className="flex-shrink-0">
          Even though he was 
        </div>
        
        <div className="">
           <span className="text-8xl inline-block shake-little shake-constant"> shivering,</span>
        </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-3xl mx-12 md:text-5xl">
          stones, sticks and dry hay.
        </div>

        <div className="flex flex-row pt-32">
        <div>
          <img className="md:h-[450px] md:w-[450px] aspect-auto mix-blend-multiply w-auto" src="images/stones.png"></img>
        </div>

        <div>
          <img className="md:h-[450px] md:w-[450px] aspect-auto mix-blend-multiply w-auto" src="images/wood.png"></img>
        </div>

        <div>
          <img className="md:h-[450px] md:w-[450px] aspect-auto mix-blend-multiply w-auto" src="images/hay.png"></img>
        </div>
      </div>
      </div>
